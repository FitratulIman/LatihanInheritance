...
namespace LatihanInheritance
{
    class Program
    {
        ...
        {
            Person person = new Person("Iman", 19);
            person.GetNameAndAge();

            Teacher teacher = new Teacher("Ibrahim", 30, "190345", "Informatic System");
            teacher.GetNameAndAge();

            Student student = new Student("M.Fitratul Iman", 19, "19.11.2809", "fitratul.2811@students.amikom.ac.id");
